      ...
      <div className='md:max-w-[872px] h-[832px] top-[530px] px-8 space-y-4 left-[300px]'>
        ...
        style={{ backgroundImage: "url('/images/ab2.png')" }}>
          ...
          <div className='md:max-w-[872px] h-fit flex gap-2 '>
              <IoCalendarNumberOutline size={24}  /><span className='text-[16px] font-[400] font-inter'>Feb 14, 2022</span>&#47;
              <TiMessages size={24}  /><span className='text-[16px] font-[400] font-inter'>3</span>&#47;
              <PiUserCirclePlus size={24}  /><span className='text-[16px] font-[400] font-inter'>Admin</span>
          </div>
