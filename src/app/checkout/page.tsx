      ...
      {data.map((item) => (
        <div 
          ...
          <div className="flex-1">
            ...
            <button onClick={handlePlaceOrder} className="w-full mt-6 px-6 py-3 bg-orange-500 text-white rounded-md shadow-sm text-sm font-medium hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
              Place an order
            </button>
