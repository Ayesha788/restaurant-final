...
<p className="text-[18px] w-full font-bold font-inter text-[#4F4F4F] px-4">Sorry, the page you are looking for does not exist. It might have been moved, deleted, or the URL could be incorrect</p>
