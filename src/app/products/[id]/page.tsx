      ...
      <div className="md:max-w-[1920px]">
        ...
        <div className="md:max-w-[1320px]  my-24 flex flex-col px-8 gap-6  md:flex-row">
          ...
          <div className="md:max-w-[615px] px-3 space-y-2 h-fit w-full">
            ...
            <h2 className="text-[32px] font-helvetica font-bold md:max-w-[510px] h-[56px]">
              $54.00
            </h2>
            <div className="flex gap-2 text-[#828282]">
              ...
              <FaStar size={16} />
              <FaStar  size={16} />
              <span className="border-x-2 px-4 text-[#828282] text-[16px] font-[400] font:inter">
                5.0 Rating
              </span>
              22 Reviews
            </div>
            <p className="text-[18px] font-inter font-[400] md:max-w-[510px] h-auto mb-4 pb-4 pt-4">
              Dictum/cursus/Risus
            </p>
            <div className="flex flex-col md:flex-row gap-6 pb-8 border-b-2">
              <div className="flex md:max-w-[181px] h-[50px]">
                <button
                  ...
                  className="w-[60px] border-2 p-2 text-[28px]"
                >
                  &#45;
                </button>
                <div className="w-[60px] border-2 pt-3 p-2 text-center">
                  {quantity}
                </div>
                <button
                  onClick={handleIncrement}
                  className="w-[60px] border-2 p-2 text-[25px]"
                >
                  &#43;
                </button>
              </div>
        ...
        <div className="md:max-w-[1320px] space-y-4 my-8 px-8 w-full">
          ...
          <p className="md:max-w-[1320px] text-justify ">
          ...
          <h2 className="text-[20px] font-helvetica font-semibold">
            Key Benefits
          </h2>
